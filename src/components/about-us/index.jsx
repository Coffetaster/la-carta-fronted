        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-6 offset-lg-3">
              <div className="main-title text-center">
                <h2 className="mt0">¿Quienes somos y a que nos dediamos?</h2>
              </div>
            </div>
          </div>
          {/* End .row */}
          ...
          <div className="row mt80">
            <div className="col-lg-6 offset-lg-3">
              <div className="main-title text-center">
                <h2>Servicios</h2>
                <p>Brindamos servicios a los locales que desean expandir su negocio.</p>
              </div>
            </div>
          </div>
          {/* End .row */}
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-6 offset-lg-3">
              <div className="main-title text-center">
                <h2>Comunidad</h2>
                <p>Nuestro tabajo ayuda a barios negocios</p>
              </div>
            </div>
          </div>
          <div className="row">
